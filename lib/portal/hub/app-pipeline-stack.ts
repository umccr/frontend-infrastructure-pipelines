...
import { HUB_APP } from '../infra/apps';
 ...
 * `lib/portal/infra/`; `HUB_APP` in `lib/portal/infra/apps.ts` is its registry entry and decides
 * which stages exist. Currently beta and prod, with no gamma.
 *
